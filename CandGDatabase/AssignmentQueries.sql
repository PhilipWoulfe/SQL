...
--Left Join Employees on Departments.Department_No = Employees.Department_No
--Right Join Jobs on Jobs.Job_ID = Employees.Job_ID 
--where Jobs.Job_ID = 'IT_PROG';

Select Distinct Departments.Department_No, Departments.Department_Name from Departments, Jobs
where Jobs.Job_ID = 'IT_PROG';

/*
Request 12 
Add the following new job IT_ANAL, System Analyst, 10000, 15000 Request 13 Update all the maximum salaries for jobs with an increase of 1000. 
 */
  --insert into jobs(Job_ID, Job_Title, Max_Salary,Min_Salary) values('IT_ANAL', 'System Analyst', 10000, 15000);
...
Request 16 
Produce a list of employees showing percentage raises, employee numbers and old and new salaries. Employees in departments 20 and 10 are given a 5% rise, employees in departments 50, 80, 90 and 110 are given a 10% rise and employees in other departments are not given a rise. IT Manager Requirements 
Request 17 
